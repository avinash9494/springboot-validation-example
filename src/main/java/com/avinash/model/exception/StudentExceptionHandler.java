package com.avinash.model.exception;
...
import com.avinash.model.ErrorResponse;

@ControllerAdvice
public class StudentExceptionHandler extends ResponseEntityExceptionHandler{

	@ExceptionHandler(Exception.class)
	public final ResponseEntity<Object> handkeAllExceptions(Exception ex, WebRequest request) {
